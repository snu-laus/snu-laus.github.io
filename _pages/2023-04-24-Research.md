...
* Urban Form and Urban Design Policy

<div class="slide-language">
  <button id="btn-ko" class="lang-btn active" type="button" onclick="changeSlide('ko')">
    KR
  </button>
  <button id="btn-en" class="lang-btn" type="button" onclick="changeSlide('en')">
    EN
  </button>
</div>
...
<iframe
  id="research-slide"
  src="https://docs.google.com/presentation/d/e/2PACX-1vRu_jAGzb5dA02ZIPsGf0zud3LO0ydpj9cuv8LR99NxTnLg6MGykZwJJKqV8GG1HABYUCA7dyIMoKXP/pubembed?start=false&loop=false"
...
<script>
  const slideKo =
    "https://docs.google.com/presentation/d/e/2PACX-1vRu_jAGzb5dA02ZIPsGf0zud3LO0ydpj9cuv8LR99NxTnLg6MGykZwJJKqV8GG1HABYUCA7dyIMoKXP/pubembed?start=false&loop=false";

  const slideEn =
    "https://docs.google.com/presentation/d/e/2PACX-1vRLX6ABDFMXhkPrHvxfbCZR03EPTxRvDivqC8ESvDQ197odON6AfczunIw1l_k9cl24OcJM9Tnu8bN4/pubembed?start=false&loop=false";

  function changeSlide(lang) {
    const slide = document.getElementById("research-slide");
...
<div class="container" id="researcharea">
    ...
    <ul>
        ...
        <li>유휴‧저이용 교육시설 유형 진단지표 시범적용 (책임연구원 / 지원: 건축공간연구원 / 2025-05-07 ~ 2025-09-03)- <a href="https://www.auri.re.kr/publication/view.es?mid=a10312000000&publication_type=research&publication_id=2235">[결과물 포함된 최종보고서 📕]</a></li>
        <li>건물ID 활용 건축물 데이터 교차검증 방안 연구 (책임연구원 / 지원: 건축공간연구원 / 2025-04-14 ~ 2025-09-10)- <a href="https://www.auri.re.kr/publication/view.es?mid=a10312000000&publication_type=research&publication_id=2211">[결과물 포함된 최종보고서 📕]</a></li>
